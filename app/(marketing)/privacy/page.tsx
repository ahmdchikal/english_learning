  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="prose prose-neutral mt-8 max-w-none space-y-6 text-muted-foreground dark:prose-invert">
        <section>
          <h2 className="text-xl font-semibold text-foreground">1. Data yang Kami Kumpulkan</h2>
          <p>
            Kami mengumpulkan nama lengkap, alamat email, dan data progres belajar (XP, streak,
            skor kuis, riwayat aktivitas) yang Anda hasilkan saat menggunakan {siteConfig.name}.
            Jika Anda mengunggah foto profil, kami juga menyimpan berkas gambar tersebut.
          </p>
        </section>
        <section>
          <h2 className="text-xl font-semibold text-foreground">2. Penggunaan Data</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-foreground">3. Penyimpanan Data</h2>
          <p>
            Seluruh data disimpan menggunakan layanan Supabase dengan Row Level Security aktif,
            yang memastikan Anda hanya dapat mengakses data milik Anda sendiri.
          </p>
        </section>
        <section>
          <h2 className="text-xl font-semibold text-foreground">4. Hak Anda</h2>
          <p>
            Anda dapat memperbarui data profil Anda kapan saja melalui halaman Pengaturan, dan
            dapat menghapus akun Anda beserta seluruh data terkait melalui halaman Profil.
          </p>
        </section>
        <section>
          <h2 className="text-xl font-semibold text-foreground">5. Kontak</h2>
          <p>
