  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="prose prose-neutral text-muted-foreground dark:prose-invert mt-8 max-w-none space-y-6">
        <section>
          <h2 className="text-foreground text-xl font-semibold">1. Penerimaan Ketentuan</h2>
          <p>
            Dengan mendaftar dan menggunakan {siteConfig.name}, Anda menyetujui syarat dan ketentuan
            yang tercantum di halaman ini.
          </p>
        </section>
        <section>
          <h2 className="text-foreground text-xl font-semibold">2. Penggunaan Layanan</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground text-xl font-semibold">3. Akun Pengguna</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground text-xl font-semibold">4. Konten Pembelajaran</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground text-xl font-semibold">5. Perubahan Layanan</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground text-xl font-semibold">6. Kontak</h2>
          <p>
