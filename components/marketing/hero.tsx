    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-white dark:from-indigo-950/30 dark:via-background dark:to-background">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-2 lg:py-28">
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2 text-sm text-muted-foreground lg:justify-start">
        ...
        <div className="relative mx-auto w-full max-w-md">
          <div className="rounded-3xl border bg-card p-5 shadow-xl shadow-indigo-200/40 dark:shadow-none">
            <div className="flex items-center justify-between border-b pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Level A1 · Pemula</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 py-4">
              ...
              <div className="rounded-2xl bg-emerald-50 p-3 dark:bg-emerald-500/10">
                <p className="text-xs text-muted-foreground">Progres Level</p>
            ...
            <div className="space-y-2 rounded-2xl border bg-muted/40 p-3">
              ...
              <p className="text-xs text-muted-foreground">3 dari 5 pelajaran selesai</p>
            </div>
