...
const BENEFITS = [
  ...
  },
  {
    ...
    description:
      "Kumpulkan XP, jaga streak harian, dan raih lencana untuk menjaga motivasi belajar.",
  },
  {
    icon: LineChart,
    title: "Pantau Progres",
    description:
      "Lihat statistik lengkap: skor kuis, waktu belajar, dan area yang perlu ditingkatkan.",
  },
];
