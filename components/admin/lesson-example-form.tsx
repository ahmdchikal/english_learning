    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
      <div className="space-y-2">
        ...
        <Input
          ...
          aria-invalid={!!errors.english_text}
        />
        {errors.english_text && (
          <p className="text-destructive text-sm">{errors.english_text.message}</p>
        )}
      </div>
      <div className="space-y-2">
        ...
        <Input
          id="indonesian_text"
          {...register("indonesian_text")}
          aria-invalid={!!errors.indonesian_text}
        />
        {errors.indonesian_text && (
          <p className="text-destructive text-sm">{errors.indonesian_text.message}</p>
        )}
      </div>
      <div className="space-y-2">
